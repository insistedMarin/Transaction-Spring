...
KEYS:
  1: key: OrderBook快照的key RedisCache.Key.ORDER_BOOK

ARGV:
  1: seqId: 本次的SequenceId String.valueOf(orderBook.sequenceId),
  2: data: OrderBook快照的JSON数据  JsonUtil.writeJson(orderBook)
